...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference("Gallery.count") do
      post galleries_url, params: { gallery: { image_prompt: @gallery.image_prompt, name: @gallery.name, send_request_on_save: @gallery.send_request_on_save, state: @gallery.state, user_id: @gallery.user_id } }
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { image_prompt: @gallery.image_prompt, name: @gallery.name, send_request_on_save: @gallery.send_request_on_save, state: @gallery.state, user_id: @gallery.user_id } }
